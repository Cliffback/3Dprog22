...
// (out of the build-folder) and then up into the project folder.
    mShaderProgram[0] = new PlainShader("../3Dprog22/plainshader.vert", "../3Dprog22/plainshader.frag");
    //mLogger->logText("Plain shader program id: " + std::to_string(mShaderProgram[0]->getProgram()));

    mShaderProgram[1] = new TextureShader("../3Dprog22/textureshader.vert", "../3Dprog22/textureshader.frag");
    //mLogger->logText("Texture shader program id: " + std::to_string(mShaderProgram[1]->getProgram()));

    mShaderProgram[2] = new PhongShader("../3Dprog22/phongshader.vert", "../3Dprog22/phongshader.frag");
    //mLogger->logText("Texture shader program id: " + std::to_string(mShaderProgram[2]->getProgram()));

    mShaderProgram[3] = new SkyBoxShader("../3Dprog22/skyboxshader.vert", "../3Dprog22/skyboxshader.frag");
    //mLogger->logText("Texture shader program id: " + std::to_string(mShaderProgram[2]->getProgram()));
